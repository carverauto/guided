defmodule GuidedWeb.UserAuthTest do
  use GuidedWeb.ConnCase, async: true

  alias Guided.Accounts
  alias Guided.Accounts.Scope
  alias GuidedWeb.UserAuth

  import Guided.AccountsFixtures

  @remember_me_cookie "_guided_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, GuidedWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
